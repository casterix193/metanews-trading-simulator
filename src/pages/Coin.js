...
export default class Coin extends React.Component {
  ...
  render() {
    ...
    return (
      <Container fluid>
        <Navbar balance={currentUSD} onLogout={this.handleLogout} />
        ...
        >
          <Col md="8" className="h-100 m-0 p-0 pb-2 pl-2 pr-lg-4">
          ...
          <Col md="4" className="h-100 m-0 p-0 pr-2 pb-2 pl-2">
            <div className="h-27_5 rounded-2 bg-dark d-flex justify-content-center align-items-center">
              <div className="h-100 w-25 d-flex justify-content-center align-items-center p-3">
            ...
            <div className="h-14_5 pt-2">
              <div
                className="rounded-2 bg-dark text-center py-2 overflow-hidden"
                style={{
                  height: '100%',
                }}
              >
            ...
            <div className="h-28 pt-2">
              ...
              >
                <h6 className="w-100">Performance</h6>
                <Table striped bordered hover variant="dark" className="w-100">
                  <tr>
                    <td>Change hour</td>
                ...
                <Form className="w-100 h-100">
                  ...
                  <div className="h-30 d-flex justify-content-center">
                    <div className="w-50 h-100 d-flex justify-content-center">
                      <Button
                        className="rounded-2 w-95 h-90 bg-green border-0"
                    ...
                    <div className="w-50 h-100 d-flex justify-content-center">
                      <Button
                        className="rounded-2 w-95 h-90 bg-red border-0"
